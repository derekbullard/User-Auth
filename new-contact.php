                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>New Contact Details <small>Fill out the form below.</small></h5>
                        ...
                        <div class="ibox-content">
                            <form action="new-contact.php" method="POST">
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Full Name</label>
                                    ...
                                    <div class="col-sm-10"><input name="contact_name" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10"><input name="contact_email" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Password</label>

                                    <div class="col-sm-10"><input name="contact_password" type="password" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button name="save" class="btn btn-primary btn-sm" type="submit">Save changes</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="ibox-content">
                      ...
                      <center><h1>Contacts</h1></center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="col-form-label" for="quantity">Password</label>
                                    ...
                                    <?php
                                          while ($row = $result->fetch_assoc()): ?>
                                              <tr>
                                                  ...
                                                  <td><?php echo $row['contactPassword']; ?></td>
                                                  <td></td>
                                              </tr>
                                          <?php endwhile; ?>
